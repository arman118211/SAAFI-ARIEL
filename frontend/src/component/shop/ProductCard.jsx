    ...
    >
      <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-full flex flex-col group border border-gray-100">
        ...
        <div className="p-4 flex-1 flex flex-col justify-between">
          {/* Category and Title */}
          <div>
            <p className="text-blue-600 text-xs font-bold uppercase tracking-widest mb-1">{product.category}</p>
            <h3 className="text-sm font-bold text-gray-900 mb-1.5 line-clamp-2 leading-tight">{product.name}</h3>
            <p className="text-gray-600 text-xs leading-relaxed mb-2 line-clamp-1">{product.description}</p>
          </div>
