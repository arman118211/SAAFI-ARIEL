		...
		<div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-indigo-50 p-4 md:p-6">
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
								...
								>
									...
									<div className="flex flex-col md:flex-row gap-4 md:gap-6">
										...
										<div className="flex-1">
											<h3 className="text-lg md:text-xl font-bold text-slate-900 mb-3 md:mb-2 text-center md:text-left">
												{product.productId.name} {product.productId.quantity}
											</h3>

											{/* Grid adjusted for 2 columns on tiny screens, 3 on tablet+ */}
											<div className="grid grid-cols-2 xs:grid-cols-3 gap-3 md:gap-4">
												<div className="bg-white/50 p-2 rounded-lg md:bg-transparent">
												...
												<div className="bg-white/50 p-2 rounded-lg md:bg-transparent">
													...
													<p className="text-[10px] md:text-xs text-slate-500">
														{product.productId.packSize} pcs/bag
													</p>
												</div>

												<div className="bg-white/50 p-2 rounded-lg md:bg-transparent col-span-2 xs:col-span-1">
													<p className="text-xs md:text-sm text-slate-600 font-semibold uppercase tracking-wider">
														Stock
													</p>
				...
				<div className="space-y-4 md:space-y-6">
					...
					>
						<h3 className="text-sm font-semibold opacity-90 mb-4 md:mb-6">
							Offer Summary
						</h3>
						...
						>
							...
							>
								<motion.div
									...
									transition={{
										duration: 0.6,
										repeat: isAutoSelecting ? Number.POSITIVE_INFINITY : 0,
									}}
								>
									<Trophy size={20} />
								</motion.div>
												...
												<div className="mt-3">
													...
													<div className="space-y-2">
														{seller.orders.map((order) => (
															<div
																key={order._id}
																className="bg-white p-2 rounded text-xs border border-slate-200"
															>
																<p className="font-semibold text-slate-800">
																	Order ID: {order.orderId._id}
																</p>
									...
									<div className="flex items-center justify-between">
										<div>
											...
											<p className="text-xs text-slate-500 mt-2">
												Total: {seller.totalQty} qty | {seller.orders.length}{" "}
												orders
											</p>
										</div>
