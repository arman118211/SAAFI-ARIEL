...
import { Plus, Edit2, Trash2, Package, Search, Filter, X, ImageIcon, AlertCircle, TrendingUp, Check, TrendingDown, Store, Users, Box, DollarSign, Tag } from "lucide-react"
...
const ProductManager = () => {
  ...
  const totalValue = products.reduce((sum, p) => sum + p.marketPrice * p.stock, 0)
                  ...
                  <AnimatePresence>
                    {filteredProducts.map((product, idx) => (
                      ...
                      >
                              ...
                              <div className="hidden sm:block max-w-xs">
                                <p
                                  className={`text-xs text-gray-500 transition-all ${
                                    expandedDesc[product._id] ? "" : "line-clamp-2"
                                  }`}
                                >
                        ...
                        <td className="px-3 md:px-4 py-3 md:py-3.5">
                          <div className="text-xs md:text-sm font-bold text-gray-900">₹ {product.marketPrice}</div>
                ...
                <div className="relative z-10 flex justify-between items-center mb-12">
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">
                      {editingProduct ? "Update product information" : "Fill in the details below to create a new product"}
                    </p>
                  </div>
                  <motion.button
              ...
              <div className="overflow-y-auto flex-1 px-6 py-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-xl border border-blue-100">
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          <label className="block text-sm font-bold text-gray-700 mb-2">Pack Size</label>
                          <input
                            type="number"
                            name="packSize"
                  ...
                  <label className="flex items-center gap-3 p-4 bg-white border-2 border-gray-200 rounded-xl cursor-pointer hover:border-blue-300 transition-all">
                    ...
                    />
                    <div>
                      <span className="text-sm font-bold text-gray-900">Active Product</span>
      ...
      {selectedProduct && (
        ...
        >
          <motion.div
            ...
            onClick={(e) => e.stopPropagation()}
            className="bg-white w-full max-w-6xl rounded-3xl shadow-2xl overflow-hidden relative"
          >
          
          {/* Close Button */}
          <button 
            onClick={() => setSelectedProduct(null)}
            className="absolute top-6 right-6 z-10 w-10 h-10 rounded-full bg-white shadow-lg hover:shadow-xl transition-all hover:scale-110 flex items-center justify-center group"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 min-h-[600px]">
            ...
            <div className="lg:col-span-2 bg-gradient-to-br from-slate-100 to-slate-50 p-8 flex flex-col justify-center items-center relative overflow-hidden">
              ...
              <div className="relative z-10 w-full max-w-md">
                ...
                {/* Floating Badge */}
                <div className="absolute -top-4 -right-4 bg-gradient-to-br from-blue-600 to-blue-700 text-white px-4 py-2 rounded-2xl shadow-xl transform rotate-3">
                  <p className="text-xs font-semibold">Best Seller</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-3 p-8 flex flex-col">
              ...
              <div className="mb-6">
                <div className="flex items-center gap-3 mb-3">
                  <span className="px-4 py-1.5 text-xs font-bold rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md">
              ...
              <div className="mt-auto">
                <h4 className="text-sm font-bold text-gray-900 mb-3">Pricing Tiers</h4>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  
                  {/* Market Price */}
                  <div className="group relative overflow-hidden rounded-xl border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-white p-4 hover:shadow-lg transition-all hover:border-blue-300">
                    <div className="absolute top-0 right-0 w-20 h-20 bg-blue-500/10 rounded-full -mr-10 -mt-10"></div>
                    <div className="relative z-10">
                      <div className="flex items-center gap-2 mb-2">
                        <TrendingDown className="w-4 h-4 text-blue-600" />
                        <p className="text-xs font-bold text-gray-600">Market Price</p>
                      </div>
                      {selectedProduct.marketDiscount > 0 && (
                        <span className="inline-block mb-2 text-xs px-2 py-1 bg-red-500 text-white font-bold rounded-md">
                          {selectedProduct.marketDiscount}% OFF
                        </span>
                      )}
                      ...
                      <p className="text-2xl font-black text-blue-600">
                        ₹{getDiscountedPrice(selectedProduct.marketPrice, selectedProduct.marketDiscount)}
                      </p>
                    </div>
                  </div>

                  {/* Retailer Price */}
                  <div className="group relative overflow-hidden rounded-xl border-2 border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-4 hover:shadow-lg transition-all hover:border-emerald-300">
                    <div className="absolute top-0 right-0 w-20 h-20 bg-emerald-500/10 rounded-full -mr-10 -mt-10"></div>
                    <div className="relative z-10">
                      <div className="flex items-center gap-2 mb-2">
                        <Store className="w-4 h-4 text-emerald-600" />
                        <p className="text-xs font-bold text-gray-600">Retailer Price</p>
                      </div>
                      {selectedProduct.retailerDiscount > 0 && (
                        <span className="inline-block mb-2 text-xs px-2 py-1 bg-red-500 text-white font-bold rounded-md">
                          {selectedProduct.retailerDiscount}% OFF
                        </span>
                      )}
                      <p className="text-xs text-gray-400 line-through mb-1">
                        ₹{selectedProduct.retailerPrice}
                      </p>
                      <p className="text-2xl font-black text-emerald-600">
                        ₹{getDiscountedPrice(selectedProduct.retailerPrice, selectedProduct.retailerDiscount)}
                      </p>
                    </div>
                  </div>

                  {/* Dealer Price */}
                  <div className="group relative overflow-hidden rounded-xl border-2 border-orange-200 bg-gradient-to-br from-orange-50 to-white p-4 hover:shadow-lg transition-all hover:border-orange-300">
                    <div className="absolute top-0 right-0 w-20 h-20 bg-orange-500/10 rounded-full -mr-10 -mt-10"></div>
                    <div className="relative z-10">
                      <div className="flex items-center gap-2 mb-2">
                        <Users className="w-4 h-4 text-orange-600" />
                        <p className="text-xs font-bold text-gray-600">Dealer Price</p>
                      </div>
                      {selectedProduct.dealerDiscount > 0 && (
                        <span className="inline-block mb-2 text-xs px-2 py-1 bg-red-500 text-white font-bold rounded-md">
                          {selectedProduct.dealerDiscount}% OFF
                        </span>
                      )}
                      <p className="text-xs text-gray-400 line-through mb-1">
                      ...
                      <p className="text-2xl font-black text-orange-600">
                        ₹{getDiscountedPrice(selectedProduct.dealerPrice, selectedProduct.dealerDiscount)}
                      </p>
                    </div>
                  </div>
                </div>
