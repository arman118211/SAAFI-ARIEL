						...
						<AnimatePresence>
                          ...
                          text-white uppercase tracking-wide shadow-sm"
											...
											<div className="flex items-center gap-2 ">
												<span
													className={`px-3 py-1.5 rounded-lg text-xs font-bold border-2 flex items-center gap-1.5 shadow-sm ${getStatusColor(
														order.status
													)}`}
													onClick={() =>
														setStatusMenuOpen(
															statusMenuOpen === order._id ? null : order._id
														)
													}
												>
														...
														{order.items.map((item, idx) => (
															...
															>
																...
																<div className="text-right min-w-[120px]">
																	...
																	{/* Discount Badge */}
																	{item.discount > 0 && (
																		<span className="inline-block mt-1 px-2 py-0.5 rounded-md bg-green-100 text-green-700 text-[11px] font-semibold">
																			{item.discount}% OFF
																		</span>
																	)}
